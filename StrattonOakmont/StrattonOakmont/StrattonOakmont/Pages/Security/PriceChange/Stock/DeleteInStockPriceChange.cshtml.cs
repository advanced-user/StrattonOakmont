...
namespace StrattonOakmont.Pages.Security.PriceChange
{
    public class DeleteInStockPriceChangeModel : PageModel
    {
        private readonly IPriceChangeRepository _priceChangeRepository;
        private readonly ICompanyRepository _companyRepository;

        public DeleteInStockPriceChangeModel(IPriceChangeRepository priceChangeRepository, ICompanyRepository companyRepository)
        {
