#pragma checksum "C:\Users\Admin\Desktop\StrattonOakmont\StrattonOakmont\StrattonOakmont\StrattonOakmont\Pages\Forecast\Forecast.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e6c1c82dfa8e2964ffa10c25a4a17593ff7c7837"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e6c1c82dfa8e2964ffa10c25a4a17593ff7c7837", @"/Pages/Forecast/Forecast.cshtml")]
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    backgr");
            WriteLiteral(@"oundColor: 'rgba(106, 90, 205, 0.5)',
                    borderWidth: 1
                }
            ]
        },
...
async function setup() {
  ...
  ");
            WriteLiteral(@"  for (let x = 0; x < x_vals.length; x++) {
        curveX.push(x + 1)
    }
...
function forecast(lenghtX) {
    ...
    cons");
            WriteLiteral(@"t ys = tf.tidy(() => predict(curveX))
    let curveY = ys.dataSync()
    ys.dispose()
